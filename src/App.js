...
class App extends Component {
  ...
  searching = event => this.setState({userInput: event.target.value})
  ...
  deleteHistory = id => {
    ...
    return this.setState({historyList: updatedList})
  }
      ...
      <div>
        <div className="header">
          ...
          <div className="search-container">
            ...
            />
            <input type="search" className="input" onChange={this.searching} />
          </div>
        </div>
